    ...
    <section >
      <div className="w-[90%]  max-w-7xl mx-auto my-20">
        <div className="flex flex-wrap justify-between pe-20 sm:pe-0 sm:justify-between ">
          {/* search products */}
          <div className="flex flex-wrap  gap-4 items-center mb-5 sm:mb-0 sm:w-[40%]">
            <input
              type="text"
              placeholder="search product here"
              className="input outline outline-1  w-[65%] h-8"
              value={searchInput}
          ...
          <div className="flex gap-2 justify-between sm:w-1/4 items-center flex-wrap">
            ...
            <select
              ...
              className="select select-sm outline outline-1">
        ...
        {/* pagination */}
        <div className="join flex flex-row align-center place-content-center">
